...
function makeDropDown(data, level1Filter) {
    ...
    const selectLevel2 = document.getElementById("selWPaddr2");
...
function applyDropDown(){
    const selectLevel1Value=document.getElementById("selWPaddr1").value;
...
function populateFirstLevelDropDown(){
    ...
    const el=document.getElementById("selWPaddr1");
...
document.getElementById("selWPaddr1").addEventListener("change",applyDropDown);
document.addEventListener("DOMContentLoaded",afterDocumentLoads);

// 攝影師案鈕
function Clickphotog(dropdown) {
    //alert(dropdown);
